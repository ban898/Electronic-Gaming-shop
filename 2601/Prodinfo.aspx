<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Prodinfo.aspx.cs" Inherits="_2601.Prodinfo" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <div class="container top-info">
              <div class="row"> 
                  <asp:Repeater ID="rprinfo" runat="server">
                        <ItemTemplate>
                           <div class="col-4">
                                   <img src="Images/Products/<%#Eval("Pimg") %>" class="w-100" height="214" />
                           </div>
                           <div class="col-8">
                               <h1 class="text-center">תיאור מוצר</h1>
                               <hr />
                               <b>
                               שם מוצר : <%#Eval("Pname") %> <br />
                               מחיר : <%#Eval("Pprice") %> <i class="fas fa-shekel-sign"></i> <br />
                               <p><%#Eval("Pdesc") %></p> <br />
                               </b>
                               <a href="ShoppingCart.aspx?Pid=<%#Eval("Pid") %>" class="btn buy">לקנייה</a>
                               <a href="Product.aspx" class="btn buy">חזור למוצרים</a>
                           </div>
                      </ItemTemplate>
                  </asp:Repeater>
              </div> 
